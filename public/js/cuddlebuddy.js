...
$.ajax({
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    unmatched.append(
      ...
      $("<h4 class='card-header mt-n4 text-center ml-n4 mr-n4'>").text(
      ...
      $(
        "<input data-id=" +
          data[i].id +
          " type='button' class='cuddle-button btn btn-primary text-center ml-5' value='Cuddle Me'>"
      ).text("Cuddle Me")
    );
  ...
  $.ajax({
    ...
    for (var i = 0; i < data.length; i++) {
      $("#matched").append(
        ...
        $(
          "<input type='button' class='btn btn-primary text-center ml-5' value='Chat'>"
        ).text("Chat")
      );
    }
  });
